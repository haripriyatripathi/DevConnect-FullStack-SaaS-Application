  ...
  useEffect(() => {
    if (developer) {
      setFormData({
        name: developer.name,
        role: developer.role,
        techStack: developer.techStack.join(', '),
        experience: developer.experience.toString(),
    ...
    <div className="max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="bg-card rounded-2xl border border-border p-8 shadow-card">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">Edit Developer</h1>
            <p className="text-sm text-muted-foreground">Update developer information</p>
          </div>
        </div>
